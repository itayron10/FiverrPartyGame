...
public class PlayerInitializer : MonoBehaviour
{
    ...
    public Transform[] GetPlayerSpawnPoints => playerSpawnPoints;
    ...
    public void InitializePlayers()
    {
        ...
        for (int i = 0; i < playerConfigs.Count; i++)
        {
            ...
            Debug.Log($"Player Index: {playerConfigs[i].PlayerIndex} Mesh: {playerConfigs[i].playerCharacter.meshPrefab}");
